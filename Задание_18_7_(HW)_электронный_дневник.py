...
print('''
        ...
        12. Дополнительные команды, которые я добавил к основному заданию
        13. Вывести список команд
...
while True:
    ...
    if command == 1:
        ...
        print('12. Дополнительные команды, которые я добавил к основному заданию')
        for student in students:
            print(f'''{student}
                    {students_marks[student]}''')
        ...
        print('''
                ...
                3. Калькулятор :-)
                4. Вывести список дополнительных команд
                5. Выход из дополнительных команд                
                ''')

        while True:
            command = int(input('Введите дополнительную команду (посмотреть список - 4): '))
            if command == 1:
                print('1. Вывести средний балл по всем предметам по каждому ученику (с округлением к ближайшей оценке)')
                # цикл по ученикам
                for student in students:
                    print(student)
                    # цикл по предметам
                ...
                print('11. Вывести средний балл по каждому предмету по определенному ученику (с округлением к ближайшей оценке)')
                # вводим имя студента
                student1 = input('Введите имя ученика: ')
                # если данные указаны верно
                if student1 in students:
                ...
                if c == '+':
                    ...
                    print('Ошибка выполнении операции')
            elif command == 4:
                print('''
                Список команд:                
                1. Вывести средний балл по всем предметам по каждому ученику (с округлением к ближайшей оценке)
                ...
                print('5. Выход из дополнительных команд')
                break
    elif command == 13:
        print ('''
        Список команд:
